...
BoW_size =  256 	# the number of words used in bag of words which is used as features for : naive bayes, k-nn, decision tree and logistic regresion classifiers
...
classifier = ClassifierLSTM(batchSize = batchSize,train_data = train_data,val_data = val_data,test_data = test_data,\
		...
		outputSize = 1, numLayers = 1, hiddenSize = 32, embedSize = 256, vocabSize = vocabSize,\
		device = 'cuda')
